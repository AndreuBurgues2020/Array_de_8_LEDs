...
void loop()
{
  ...
  delay(Delay);                  // es queden leds 500ms apagats
  ...
  delay(Delay);                  // es queden leds 500ms apagats  digitalWrite(led0, HIGH);    // posar a 5V el pin 5
  ...
  delay(Delay);                  // es queden leds 500ms encesos
